package com.aitrade.common.utils.file;
...
import com.aitrade.common.exception.file.FileNameLengthLimitExceededException;
import com.aitrade.common.exception.file.FileSizeLimitExceededException;
import com.aitrade.common.exception.file.InvalidExtensionException;
import com.aitrade.common.utils.DateUtils;
import com.aitrade.common.utils.StringUtils;
import com.aitrade.common.utils.uuid.IdUtils;
import com.aitrade.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = AiTradeConfig.getProfile();
    ...
    {
        int dirLastIndex = AiTradeConfig.getProfile().length() + 1;
